...
class MyWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Tadbirkorlik statistikasi")
        self.setGeometry(100, 100, 200, 200)  # Oynaning o'lchami

        # 1-tugma yaratish
        self.button1 = QPushButton('Topik yaratish', self)
        # 1-tugma bosilganda run1 funksiyasini chaqiradi
        self.button1.clicked.connect(self.run1)

        # 2-tugma yaratish
        self.button2 = QPushButton('Oynani yopish', self)
        self.button2.setIcon(QIcon('close.png')
                             )  # Ikonkani qo'shish
