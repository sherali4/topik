...
class Engkup:
    ...
    def hudud(self):
        ...
        # return kursatkich2
        replace_text_in_doc(self.eski_nomi, self.yangi_nomi,
...
print(Engkup('357.docx', '357.docx', '@h1', 'C', 1).kursatkich)
print(Engkup('357.docx', '357.docx', '@k1', 'C', 1).kursatkich)
print(Engkup('357.docx', '357.docx', '@h2', 'C', 1).kursatkich)
print(Engkup('357.docx', '357.docx', '@k2', 'C', 1).kursatkich)
