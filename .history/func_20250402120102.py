...
hudud_ru = ['Андижанская область', 'Бухарская область', 'Джизакская область', 'Кашкадарьинская область', 'Навоийская область', 'Наманганская область',
            'Самаркандская область', 'Сурхандарьинская область', 'Сирдарьинская область', 'Город Ташкент', 'Toshkent область', "Farg'ona область", 'Xorazm область', "Qoraqalpog'iston Respublikasi"]
