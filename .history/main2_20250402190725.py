...
class Engkup:
    ...
    def __init__(self, file_nomi, uzgarmas,  ustun, urin, ustun_nomi):
        self.ustun = kiril_to_latin(ustun)
        self.file_nomi = file_nomi
        self.ustun_nomi = ustun_nomi
    ...
    @property
    def ustun(self, ustun):
        self.ustun_nomi = ustun
...
Engkup('357.docx', '@h1', 'C', 1).hudud
Engkup('357.docx', '@hr1', 'C', 1).hudud_ru
Engkup('357.docx', '@k1', 'C', 1).kursatkich
Engkup('357.docx', '@h2', 'C', 2).hudud
Engkup('357.docx', '@hr2', 'C', 2).hudud_ru
Engkup('357.docx', '@k2', 'C', 2).kursatkich
