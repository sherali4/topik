...
class Engkup:
    ...
    def __init__(self, file_nomi, uzgarmas,  ustun, urin):
...
hudud = ['Andijon viloyati', 'Buxoro viloyati', 'Jizzax viloyati', 'Qashqadaryo viloyati', 'Navoiy viloyati', 'Namangan viloyati',
         'Samarqand viloyati', 'Surxondaryo viloyati', 'Sirdaryo viloyati', 'Toshkent shahri', 'Toshkent viloyati', "Farg'ona viloyati", 'Xorazm viloyati', "Qoraqalpog'iston Respublikasi"]
hudud_ru = ['Андижанская область', 'Бухарская область', 'Джизакская область', 'Кашкадарьинская область', 'Навоийская область', 'Наманганская область',
            'Самаркандская область', 'Сурхандарьинская область', 'Сирдарьинская область', 'Город Ташкент', 'Ташкент область', "Ферганская область", 'Хорезмская область', "Республика Каракалпакстан"]


hudud_ru = {
    'Andijon viloyati':'Андижанская область',
    'Buxoro viloyati':'Бухарская область',
    'viloyati':'Джизакская область',
    'viloyati':'Кашкадарьинская область',
    'viloyati':'Навоийская область',
    'viloyati':'Наманганская область',
    'viloyati':'Самаркандская область',
    'viloyati':'Сурхандарьинская область',
    'viloyati':'Сирдарьинская область',
    'viloyati':'Город Ташкент',
    'viloyati':'Ташкент область',
    'viloyati':"Ферганская область",
    'viloyati':'Хорезмская область',
