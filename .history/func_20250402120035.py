...
hudud_ru = ['Андижанская область', 'Бухарская область', 'Джизакская область', 'Кашкадарьинская область', 'Навоийская область', 'Наманганская область',
            'Самаркандская область', 'Surxondaryo область', 'Sirdaryo область', 'Toshkent shahri', 'Toshkent область', "Farg'ona область", 'Xorazm область', "Qoraqalpog'iston Respublikasi"]
