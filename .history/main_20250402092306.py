...
class Engkup:
    ...
    def __init__(self, ustun, kursatkich_nomi):
        ...
        print(self.dan, self.gacha)
        selfhududlar = ['Andijon viloyati', 'Buxoro viloyati', 'Jizzax viloyati', 'Qashqadaryo viloyati', 'Navoiy viloyati', 'Namangan viloyati',
                'Samarqand viloyati', 'Surxondaryo viloyati', 'Sirdaryo viloyati', 'Toshkent shahri', 'Toshkent viloyati', "Farg'ona viloyati", 'Xorazm viloyati', "Qoraqalpog'iston Respublikasi"]

    def get_dict(self):
        eng_kup_hudud(self.ustun, self.dan, self.gacha, self.hudular)
