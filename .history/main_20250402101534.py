...
class Engkup:
    ...
    def hudud1(self, urin):
        ...
        kursatkich2 = eng_katta(kursatkich, 1, urin=urin)
        return kursatkich2

    @property
    def kursatkich1(self, urin):
        kursatkich = eng_kup_hudud(
            self.ustun, self.dan, self.gacha, self.hududlar)
        kursatkich2 = eng_katta(kursatkich, 0, urin=urin)
        return kursatkich2


print(Engkup('C', 'Qurilish').kursatkich(1))
