...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QPushButton, QVBoxLayout, Qicon
...
class MyWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Tugma va Oyna")
        self.setGeometry(100, 100, 200, 200)  # Oynaning o'lchami

        # 1-tugma yaratish
        self.button1 = QPushButton('Tugma 1', self)
        # 1-tugma bosilganda run1 funksiyasini chaqiradi
        self.button1.clicked.connect(self.run1)

        # 2-tugma yaratish
        self.button2 = QPushButton('Tugma 2', self)
        self.button2.setIcon(QIcon('path/to/your/icon.png'))  # Ikonkani qo'shish
        # 2-tugma bosilganda run2 funksiyasini chaqiradi
        self.button2.clicked.connect(self.close1)
        # Layout
        layout = QVBoxLayout()
    ...
    def run1(self):
        run2()
        print("run1 funksiyasi bajarilmoqda...")
        # Funksiya tugagandan so'ng oynani yopamiz
