...
# EXE ishlayotgan papkani aniqlash
if getattr(sys, 'frozen', False):
    base_path = sys._MEIPASS  # PyInstaller vaqtinchalik papkasi
else:
    base_path = os.path.abspath(".")

# Fayl yo‘llarini moslashtirish
excel_file = os.path.join(base_path, "baza.xlsx")
docx_file = os.path.join(base_path, "example.docx")
...
# period
replace_text_in_doc("example.docx", docx_file, "period_uz", "mart")
replace_text_in_doc(docx_file, docx_file, "period_ru", "март")

# Foydalanish:
replace_text_in_doc(docx_file, docx_file, "2023_raqam",
                    from_excel('ulush', 'B4'))
