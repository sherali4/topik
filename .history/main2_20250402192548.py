...
class Engkup:
    ...
    def __init__(self, file_nomi, uzgarmas, ustun, urin):
        ...
        self._ustun = kiril_to_latin(ustun)
    ...
    def ustun(self, value):
        self._ustun = kiril_to_latin(value)  # Transliterate to Latin

    @property
    def hudud(self):
        kursatkich = eng_kup_hudud(
            self._ustun, self.dan, self.gacha, self.hududlar)
...
eng_kup_object.ustun = "Yangi ustun"
