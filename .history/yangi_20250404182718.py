...
class Filltopic:
    ...
    def hudud_ru(self, tag):
        ...
        kursatkich = func.eng_kup_hudud(
            self.ustun, self.dan, self.gacha, viloyatlar.viloyatlar_uz, self.list_excel)
        kursatkich2 = func.eng_katta(kursatkich, 1, urin=self.urin)
    ...
    def kursatkich(self):
        ...
        kursatkich2 = func.eng_katta(kursatkich, 0, urin=self.urin)
        func.replace_text_in_doc(tempfile, self.file_nomi,
                                 self.uzgarmas, kursatkich2)
