...
class Engkup:
    ...
    @property
    def manzil(self):
        print('Sherali Axmedov Isoqovich')
        # print(manzil(name, period))
...
qurilish = Engkup()
qurilish.ustun = 'C'
qurilish.file_nomi = "357.docx"
qurilish.kitob = 'ulush'
qurilish('@h1', 1).hudud
qurilish('@hr1', 1).hudud_ru
qurilish('@k1', 1).kursatkich
qurilish('@h2', 2).hudud
qurilish('@hr2', 2).hudud_ru
qurilish('@k2', 2).kursatkich
# Engkup.manzil = 'qurilish', '2024'


# print(manzil('qurilish', '2024'))
