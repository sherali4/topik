...
def get_sorted_excel_data_as_dict(file_path, column, start_row, end_row):
    ...
    # Tartiblangan lug‘at qaytarish
    return dict(sorted(data_dict.items()))


# Foydalanish
sorted_excel_data = get_sorted_excel_data_as_dict("baza.xlsx", "B", 4, 18)
print(sorted_excel_data)
