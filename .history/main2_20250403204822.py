...
class MyWindow(QWidget):
    def __init__(self):
        ...
        # Oyna sarlavhasi
        self.setWindowTitle('PyQt5 Test Dasturi')

        # Etiket (label) yaratish
        self.label = QLabel('Salom, PyQt5!', self)

        # Tugma yaratish
        self.button = QPushButton('Klikla!', self)
        # Tugma bosilganda qanday ish bajarilishini belgilash
        self.button.clicked.connect(self.on_click)

        # Layout yaratish va elementlarni markazga joylashtirish
        layout = QVBoxLayout()
        layout.addWidget(self.label)
        layout.addWidget(self.button)

        # Layoutni oyna ustiga o'rnatish
        self.setLayout(layout)

        # Tugma va etiketni markazga joylashtirish
        layout.setAlignment(self.button, 1)  # 1: Qt.AlignCenter

    def on_click(self):
        # Tugma bosilganda matnni o‘zgartirish
        self.label.setText('Tugma bosildi!')


# Dastur ishga tushirilganda, oynani yaratish
app = QApplication(sys.argv)
window = MyWindow()
window.setGeometry(100, 100, 640, 320)  # Oynaning o‘lchamlari va joylashuvi
window.show()
