...
class FirstWindow(QMainWindow):
    def __init__(self, switch_callback):
        ...
        self.setWindowTitle("Тадбиркорлик статистикаси")
        self.resize(600, 300)
        ...
        # Label
        label = QLabel("Тадбиркорлик статистикаси")
        layout.addWidget(label)

        # Button 1
        self.button1 = QPushButton("Кичик тадбиркордик", self)
        self.button1.clicked.connect(self.on_button1_click)
        layout.addWidget(self.button1)

        # Button 2
        self.button2 = QPushButton("Кичик корхона ва микрофирмалар", self)
    ...
    def create_menus(self, menubar, switch_callback):
        ...
        topik_menu = menubar.addMenu("📂 Топиклар")
        press_menu = menubar.addMenu("📂 Пресс-Релиз")
        open_d_menu = menubar.addMenu("📂 OPEN-DATA")
        ...
        topik_menu.addAction(QAction("Файл маълумотлари", self))
...
class SecondWindow(QMainWindow):
    ...
    def create_menus(self, menubar, switch_callback):
        ...
        topik_menu.addAction(QAction("Фойдаланувчи маълумотлари", self))
